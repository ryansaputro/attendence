      ...
      <div class="col-12">
        <div class="card card-default login-style">
          ...
          <div class="card-body login-body">
            <h5 class="text-center mb-3 mt-3" style="color:#fff;">Administrator</h5>
            ...
            <img v-bind:src="'https://pkc.rfidtotalsolution.com/assets/img/logo-pupuk-kujang.png'" class="img-vendor" /> 
